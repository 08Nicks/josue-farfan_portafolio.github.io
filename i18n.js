...
(function () {
  ...
  "es": {
    ...
    "hero_title": "Del silicio a la realidad: <span class=\"gradient-text\">hardware que cobra vida</span>.",
    "hero_desc": "¡Hola! Soy <strong>Josué Farfán González</strong>, estudiante de <strong>Electrónica en la BUAP</strong> con estancia de investigación en el <strong>INAOE</strong>. Especializado en diseño de microelectrónica en silicio (TSMC 28nm), sistemas embebidos y lógica digital en FPGAs.",
  ...
  "en": {
    ...
    "hero_motto": "Forging the Digital Reality",
    "hero_title": "From silicon to reality: <span class=\"gradient-text\">bringing hardware to life</span>.",
    "hero_desc": "Hello! I am <strong>Josué Farfán González</strong>, an <strong>Electronics Engineering senior at BUAP</strong> with research at <strong>INAOE</strong>. Specialized in custom nanometer silicon design (TSMC 28nm), embedded systems, and digital FPGA architectures.",
