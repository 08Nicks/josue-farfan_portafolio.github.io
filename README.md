...
Sitio web estático de ingeniería y portafolio de proyectos de hardware, microelectrónica (TSMC 28nm, Cleanroom), FPGAs Spartan, sistemas embebidos IoT (ESP32), electrónica de potencia, radiofrecuencia (2.45 GHz) y visión artificial (FastALPR).
